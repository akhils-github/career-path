    ...
    <div className="flex bg-[#F8F9FA] w-full overflow-hidden">
      ...
      <div className=" bg-red-70s0 w-full px-20">
        <p className="flex justify-end w-full  gap-1.5 text-sm py-4">
          Already Registered? <span className="text-[#275DF5]">Login </span> here
        </p>

        <div className="bg-[#FFFFFF] rounded lg:px-20 md:px-6 py-6 shadow-md w-10/12  ">
            <h3 className="font-bold text-lg px-3">
              Create account faster using
            </h3>
            <div className="flex gap-4 my-3 px-3">
              <div>Facbook</div>
              <div>Facbook</div>
              <div>Facbook</div>
            </div>
                  ...
                  <div className="flex px-3 group flex-col space-y-2">
                    ...
                    <div className="flex  gap-2">
                      ...
                      <span className="text-xs font-medium text-[#00000080]">
                        ...
                        governing the user of accountz.com
                      </span>
                    </div>
                    {/* {errors.owner && (
                      <span className="text-xs font-medium text-red-500">
